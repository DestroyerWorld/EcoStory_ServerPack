namespace Eco.Mods.WorldLayers
{
    ...
    public class SpeciesHabitabilityLayerSettingsMountainGoatCapacity : SpeciesHabitabilityLayerSettings
    {
        public SpeciesHabitabilityLayerSettingsMountainGoatCapacity() : base()
        {
            ...
            this.HabitabilityComponents.Add( new ConsumerComponent() { CalorieConsumption = 75, Prey = new List<Type> { typeof(PlantLayerSettingsPeatMoss), typeof(PlantLayerSettingsLupine) , typeof(PlantLayerSettingsFireweed), typeof(PlantLayerSettingsSaxifrage), typeof(PlantLayerSettingsArcticWillow), typeof(PlantLayerSettingsDwarfWillow) } } );
