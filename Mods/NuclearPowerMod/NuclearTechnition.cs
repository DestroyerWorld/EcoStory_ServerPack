namespace Eco.Mods.TechTree
{
    ...
    {
        public override LocString DisplayName        { get { return Localizer.DoStr("Nuclear Technition"); } }
        public override LocString DisplayDescription { get { return Localizer.DoStr("You probably want someone who knows their stuff when working with nuclear reactors..."); } }
    ...
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Nuclear Technition Skill Book"); } }
    }

    [Serialized]
    public partial class NuclearTechnitionSkillScroll : SkillScroll<NuclearTechnitionSkill, NuclearTechnitionSkillBook>
    {
        public override LocString DisplayName { get { return Localizer.DoStr("Nuclear Technition Skill Scroll"); } }
    }

    [RequiresSkill(typeof(AdvancedSmeltingSkill), 0)] 
    public partial class NuclearTechnitionSkillBookRecipe : Recipe
    {
