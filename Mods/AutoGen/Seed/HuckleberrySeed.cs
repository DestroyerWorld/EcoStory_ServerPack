namespace Eco.Mods.TechTree
{
    ...
    public class HuckleberrySeedRecipe : Recipe
    {
        public HuckleberrySeedRecipe()
        {
            ...
            {
                new CraftingElement<HuckleberriesItem>(typeof(FarmingSkill), 4, FarmingSkill.MultiplicativeStrategy, typeof(FarmingLavishResourcesTalent))   
            };
            this.CraftMinutes = CreateCraftTimeValue(typeof(HuckleberrySeedRecipe), Item.Get<HuckleberrySeedItem>().UILink(), 1, typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));    
