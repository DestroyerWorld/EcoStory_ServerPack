namespace Eco.Mods.TechTree
{
    ...
    public partial class SmallStandingStoneSignRecipe : Recipe
    {
        public SmallStandingStoneSignRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(SmallStandingStoneSignRecipe), Item.Get<SmallStandingStoneSignItem>().UILink(), 10, typeof(MortaringSkill), typeof(MortaringFocusedSpeedTalent), typeof(MortaringParallelSpeedTalent));    
