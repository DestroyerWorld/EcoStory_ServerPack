    ...
    public partial class RealEstateDeskRecipe : Recipe
    {
        public RealEstateDeskRecipe()
        {
            ...
            this.Ingredients = new CraftingElement[]
            {
                ...
                new CraftingElement<PlantFibersItem>(typeof(HewingSkill), 50, HewingSkill.MultiplicativeStrategy, typeof(HewingLavishResourcesTalent)),          
            };
            this.ExperienceOnCraft = 5;  
            this.CraftMinutes = CreateCraftTimeValue(typeof(RealEstateDeskRecipe), Item.Get<RealEstateDeskItem>().UILink(), 5, typeof(HewingSkill), typeof(HewingFocusedSpeedTalent), typeof(HewingParallelSpeedTalent));    
