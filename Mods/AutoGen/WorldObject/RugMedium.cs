namespace Eco.Mods.TechTree
{
    ...
    public partial class RugMediumRecipe : Recipe
    {
        public RugMediumRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(RugMediumRecipe), Item.Get<RugMediumItem>().UILink(), 20, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));    
