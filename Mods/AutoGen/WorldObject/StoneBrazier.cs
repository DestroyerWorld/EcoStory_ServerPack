namespace Eco.Mods.TechTree
{
    ...
    public partial class StoneBrazierRecipe : Recipe
    {
        public StoneBrazierRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(StoneBrazierRecipe), Item.Get<StoneBrazierItem>().UILink(), 10, typeof(MortaringSkill), typeof(MortaringFocusedSpeedTalent), typeof(MortaringParallelSpeedTalent));    
