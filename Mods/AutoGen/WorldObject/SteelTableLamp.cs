    ...
    public partial class SteelTableLampRecipe : Recipe
    {
        public SteelTableLampRecipe()
        {
            ...
            this.Ingredients = new CraftingElement[]
            {
                ...
                new CraftingElement<SteelItem>(typeof(ElectronicsSkill), 16, ElectronicsSkill.MultiplicativeStrategy, typeof(ElectronicsLavishResourcesTalent)),
                new CraftingElement<PlasticItem>(typeof(ElectronicsSkill), 10, ElectronicsSkill.MultiplicativeStrategy, typeof(ElectronicsLavishResourcesTalent)),          
            };
            this.ExperienceOnCraft = 5;  
            this.CraftMinutes = CreateCraftTimeValue(typeof(SteelTableLampRecipe), Item.Get<SteelTableLampItem>().UILink(), 10, typeof(ElectronicsSkill), typeof(ElectronicsFocusedSpeedTalent), typeof(ElectronicsParallelSpeedTalent));    
