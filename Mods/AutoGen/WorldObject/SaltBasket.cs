namespace Eco.Mods.TechTree
{
    ...
    public partial class SaltBasketRecipe : Recipe
    {
        public SaltBasketRecipe()
        {
            ...
            {
                new CraftingElement<BoardItem>(typeof(FarmingSkill), 20, FarmingSkill.MultiplicativeStrategy, typeof(FarmingLavishResourcesTalent)),          
            };
            this.ExperienceOnCraft = 3;  
            this.CraftMinutes = CreateCraftTimeValue(typeof(SaltBasketRecipe), Item.Get<SaltBasketItem>().UILink(), 5, typeof(FarmingSkill), typeof(FarmingFocusedSpeedTalent), typeof(FarmingParallelSpeedTalent));    
