namespace Eco.Mods.TechTree
{
    ...
    public partial class PlanterPotRoundRecipe : Recipe
    {
        public PlanterPotRoundRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(PlanterPotRoundRecipe), Item.Get<PlanterPotRoundItem>().UILink(), 5, typeof(MortaringSkill), typeof(MortaringFocusedSpeedTalent), typeof(MortaringParallelSpeedTalent));    
