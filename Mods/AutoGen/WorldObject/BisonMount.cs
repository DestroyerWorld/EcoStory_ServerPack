namespace Eco.Mods.TechTree
{
    ...
    public partial class BisonMountRecipe : Recipe
    {
        public BisonMountRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(BisonMountRecipe), Item.Get<BisonMountItem>().UILink(), 15, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));    
