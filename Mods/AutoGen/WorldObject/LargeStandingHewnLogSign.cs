namespace Eco.Mods.TechTree
{
    ...
    public partial class LargeStandingHewnLogSignRecipe : Recipe
    {
        public LargeStandingHewnLogSignRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(LargeStandingHewnLogSignRecipe), Item.Get<LargeStandingHewnLogSignItem>().UILink(), 10, typeof(HewingSkill), typeof(HewingFocusedSpeedTalent), typeof(HewingParallelSpeedTalent));    
