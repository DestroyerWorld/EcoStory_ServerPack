namespace Eco.Mods.TechTree
{
    ...
    public partial class WashboardRecipe : Recipe
    {
        public WashboardRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(WashboardRecipe), Item.Get<WashboardItem>().UILink(), 5, typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));    
