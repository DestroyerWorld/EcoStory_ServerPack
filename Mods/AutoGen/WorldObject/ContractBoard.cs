namespace Eco.Mods.TechTree
{
    ...
    public partial class ContractBoardRecipe : Recipe
    {
        public ContractBoardRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(ContractBoardRecipe), Item.Get<ContractBoardItem>().UILink(), 15, typeof(HewingSkill), typeof(HewingFocusedSpeedTalent), typeof(HewingParallelSpeedTalent));    
