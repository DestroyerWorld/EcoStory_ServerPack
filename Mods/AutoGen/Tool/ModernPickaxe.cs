namespace Eco.Mods.TechTree
{
    ...
    public partial class ModernPickaxeRecipe : Recipe
    {
        public ModernPickaxeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(ModernPickaxeRecipe), Item.Get<ModernPickaxeItem>().UILink(), 0.5f, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));    
    ...
    public partial class ModernPickaxeItem : PickaxeItem
    {
        ...
        private static IDynamicValue caloriesBurn = CreateCalorieValue(10, typeof(MiningSkill), typeof(ModernPickaxeItem), new ModernPickaxeItem().UILink());
        ...
        private static IDynamicValue tier = new MultiDynamicValue(MultiDynamicOps.Sum, new ConstantValue(6), new TalentModifiedValue(typeof(MiningToolStrengthTalent), 0)); 
