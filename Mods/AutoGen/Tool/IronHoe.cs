namespace Eco.Mods.TechTree
{
    ...
    public partial class IronHoeRecipe : Recipe
    {
        public IronHoeRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(IronHoeRecipe), Item.Get<IronHoeItem>().UILink(), 0.5f, typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));    
    ...
    public partial class IronHoeItem : HoeItem
    {
        ...
        private static IDynamicValue caloriesBurn = CreateCalorieValue(17, typeof(FarmingSkill), typeof(IronHoeItem), new IronHoeItem().UILink());
